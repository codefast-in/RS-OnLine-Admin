...
export default function Page() {
  return (
    <div className="flex h-screen flex-col items-center justify-center sm:p-12  md:p-24 bg-[linear-gradient(110deg,#fff,45%,#f2f2f2,55%,#fff)] bg-[length:200%_100%] animate-shimmer">

...
export const columns: ColumnDef<Products, any>[] = [
  ...
  },
  {
    accessorKey: "stock",
    header: "Stock",
    cell: ({row}) => <Image src={row.getValue("stock")} height={100} width={100} alt={row.getValue("title")} className="rounded-full h-12 w-12 border"/>,
  },
  {
    accessorKey: "title",
    header: ({column}) => {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link href={`/admin/products/electronics/${Products.id}`}>
